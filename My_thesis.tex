...
\input{my_folder/intro}	    	 % Введение
...
\input{my_folder/concl}        	 % Заключение
...
\input{my_folder/appendix-ddpg-alg} % Приложение 1

\input{my_folder/appendix-maddpg-alg} % Приложение 2

\input{my_folder/appendix-code}
