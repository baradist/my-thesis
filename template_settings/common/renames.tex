...
%%
%%
\newcommand{\abstractEn}{In this thesis Reinforcement Learning and its applicability to Multi-Agent systems were examined. Specifically, Multi Agent Deep Deterministic Policy Gradient was reviewed. Communication between agents was researched. Different optimizing methods were suggested, implemented and tested. Experiments were set up on different scenarious in 2D-environment  multiagent-particle-envs \cite{multiagent-particle-envs} by OpenAI.} % ВВЕДИТЕ текст аннотации по-английски
