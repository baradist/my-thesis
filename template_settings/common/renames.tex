...
\newcommand{\abstractRu}{Предмет исследования~--- это применимость обучения с подкреплением к мультиагентным системам. Цель работы~--- разработка и исследование алгоритмов управления МАС с применением технологий глубокого обучения с подкреплением. За основу взят алгоритм MADDPG, модифицирован и поставлены эксперименты в мультиагентной среде, где измерялось общение агентов между собой, а также производительность с разными вариантами алгоритма. В результате работы MADDPG расширен  до более сложного сценария – многомерные пространства действий: движение и общение. MADDPG  был модифицирован для работы с одним мозгом, в условиях, когда пространства наблюдений и действий у агентов совпадают. Результаты исследования могут быть дополнительно разработаны и широко использованы во многих практических реальных приложениях в области экономики, управления, техники и т.д.} % ВВЕДИТЕ текст аннотации по-русски
%%
%%
\newcommand{\abstractEn}{The subject of research is the applicability of Reinforcement Learning to multi-agent systems. The purpose of this work is to develop and research algorithms for controlling multi-agent systems using Deep Reinforcement Learning. The MADDPG was taken as a basis, experiments were modified and set up in a multi-agent environment, where the communication between agents was measured, as well as performance with different variants of the algorithm. As a result of this work, MADDPG has been expanded to a more complex scenario - multidimensional action spaces: movement and communication. MADDPG has been modified to work with one brain, in conditions when the observation and action spaces of agents coincide. The research results can be further developed and widely used in many practical real applications in the field of economics, management, technology, etc.} % ВВЕДИТЕ текст аннотации по-английски
